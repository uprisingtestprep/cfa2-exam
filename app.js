/* CFA2 Exam Simulator, Application Logic */

const ACCESS_CODE  = "CFA29000";
const EXAM_SECONDS = 15840;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "cfa2_exam_state_v1";
const SIM_Q_COUNT  = 88;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const CLUSTER_LABEL = "Vignette";
const DOMAIN_LABELS = {"quantitative_methods": "Quantitative Methods", "economics": "Economics", "corporate_issuers": "Corporate Issuers", "derivatives": "Derivatives", "alternative_investments": "Alternative Investments", "financial_statement_analysis": "Financial Statement Analysis", "equity_investments": "Equity Investments", "fixed_income": "Fixed Income", "portfolio_management": "Portfolio Management", "ethical_and_professional_standards": "Ethical and Professional Standards"};  // maps domain key -> human-readable label for display
...
function showResults() {
  ...
  const aboveBenchmark = pct >= PASSING_PCT;
  document.getElementById("res-status").textContent = aboveBenchmark ? "ABOVE BENCHMARK" : "BELOW BENCHMARK";
  document.getElementById("res-status").style.color = aboveBenchmark ? "#059669" : "#DC2626";
